...
def main(args):
    ...
    meta_learner = DDP(meta_learner.to(device), device_ids=[args.gpu])
        ...
        for x, y in loader:
            ...
            if rank == 0:
                if train_steps % args.ckpt_every == 0 and train_steps > 0:
                    ...
                    meta_learner_weight = meta_learner.module.state_dict()
                    checkpoint = {
                        "model": model_weight,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vq-ckpt", type=str,
                        default=r"results_tokenizer_image/002-VQ-8/checkpoints/ckpt0_swin100M_IN1000.pth",
                        help="ckpt path for vq model")
    parser.add_argument("--save-image", default=True, type=bool, required=False)
    parser.add_argument("--code-path", default=r"data/datasets/IN1000", type=str, required=False)
    ...
    parser.add_argument("--global-batch-size", type=int, default=32*8)
    parser.add_argument("--global-seed", type=int, default=0)
    parser.add_argument("--num-workers", type=int, default=24)
    parser.add_argument("--log-every", type=int, default=100)
    parser.add_argument("--log-image-every", type=int, default=500)
